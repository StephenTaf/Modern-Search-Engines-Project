...
DB_PATH = "crawlerDb_sbert.duckdb"#"crawlerDb.duckdb"  # Path to the DuckDB database
...
DEFAULT_WINDOW_SIZE = 512#256  # Default window size for sliding windows
DEFAULT_STEP_SIZE = 450#200  # Default step size for sliding windows
...
USE_BM25 = True  # Whether to use BM25 for indexing, we do not use it anymore